...
public class MemberDAO {
	...
	public List<MemberDTO> list() {
		...
		try {
			...
			while (rs.next()) {
				list.add(new MemberDTO(rs.getString(1), rs.getString(2), rs.getString(3),rs.getString(4),rs.getInt(5)));
			}
	...
	public MemberDTO login(String id, String pw) {
		...
		try {
			...
			if (rs.next()) {
				...
				login = new MemberDTO(id, pw, name,rs.getString(4),rs.getInt(5));
			}
